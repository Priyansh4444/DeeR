      ...
      return (
        <AgoraRTCProvider client={client}>
          ...
          <div className="fixed z-10 bottom-0 left-0 right-0 flex justify-center pb-4">
            <a
              className="px-5 py-3 text-base font-medium text-center text-white bg-red-500 rounded-lg hover:bg-red-600 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900 w-40"
              href="/"
            >
              End Call
            </a>
